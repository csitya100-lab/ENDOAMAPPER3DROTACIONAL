            ...
            <div className="flex items-center gap-3">
              ...
              {isAuthenticated && user && (
                <div className="flex items-center gap-2 ml-2 pl-2 border-l border-slate-200">
                  ...
                  <span className="text-sm font-medium text-slate-700" data-testid="text-layout-user-name">
                    {user.firstName}
                  </span>
                  <a
                    href="/api/logout"
                    className="p-1.5 rounded-md text-slate-400 hover:text-rose-500 hover:bg-slate-100 transition-colors"
                    title="Sair"
